...
#
# Script generated by Vivado on Mon Apr 14 02:31:06 +0530 2025
...
#
# Usage        : top_tb.sh
#                top_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_tb.sh [-reset_run]
#                top_tb.sh [-reset_log]
#                top_tb.sh [-help]
#
...
# script info
echo -e "top_tb.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top_tb xil_defaultlib.top_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_tb -key {Behavioral:sim_1:Functional:top_tb} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Vivado/2024.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_10)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_tb.wdb xsim.dir libdpi.so)
...
Usage: top_tb.sh [-step]\n\
Usage: top_tb.sh [-lib_map_path]\n\
Usage: top_tb.sh [-reset_run]\n\
Usage: top_tb.sh [-reset_log]\n\
Usage: top_tb.sh [-keep_index]\n\
