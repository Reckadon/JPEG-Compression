...
HD_PWD='C:/Users/GSRAJA/Desktop/IIT GN/sem 4/ES 204/Project/code3/iter3/iter3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dct_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dct_top.tcl
