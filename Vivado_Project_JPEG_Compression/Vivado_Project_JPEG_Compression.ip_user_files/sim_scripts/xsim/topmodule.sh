...
#
# Script generated by Vivado on Wed Apr 16 02:44:02 +0530 2025
...
# script info
echo -e "topmodule.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot topmodule xil_defaultlib.topmodule xil_defaultlib.glbl -log elaborate.log
}
